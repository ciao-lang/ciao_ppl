/* Prolog Polyhedron interface code: definitions.
...
#include "ppl_prolog_Polyhedron.hh"
#include "ppl_prolog_sysdep.hh"
#include "ppl_prolog_common_defs.hh"

extern "C" Prolog_foreign_return_type
  ppl_delete_Polyhedron(Prolog_term_ref t_ph) {
  static const char* where = "ppl_delete_Polyhedron/1";
  try {
    const Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_UNREGISTER(ph);
    delete ph;
...
ppl_new_C_Polyhedron_from_space_dimension(Prolog_term_ref t_nd,
  ...
  static const char* where = "ppl_new_C_Polyhedron_from_space_dimension/3";
  try {
    C_Polyhedron* ph;
...
ppl_new_NNC_Polyhedron_from_space_dimension(Prolog_term_ref t_nd,
                                               Prolog_term_ref t_uoe,
                                               Prolog_term_ref t_ph) {
  static const char* where = "ppl_new_NNC_Polyhedron_from_space_dimension/3";
  try {
    NNC_Polyhedron* ph;
    Prolog_atom uoe = term_to_universe_or_empty(t_uoe, where);
                     ...
                     Prolog_term_ref t_cc)
{
  ...
  try {
    ...
    PPL_CHECK(ph_source);
    ph = new C_Polyhedron(*ph_source, cc);
                     ...
                     Prolog_term_ref t_cc)
{
  ...
  try {
    ...
    PPL_CHECK(ph_source);
    ph = new NNC_Polyhedron(*ph_source, cc);
                                                    ...
                                                    Prolog_term_ref t_ph)
{
  ...
  try {
    ...
    C_Polyhedron* ph;
    ph = new C_Polyhedron(cs, Recycle_Input());
    Prolog_term_ref tmp = Prolog_new_term_ref();
    Prolog_put_address(tmp, ph);
    if (Prolog_unify(t_ph, tmp)) {
      PPL_REGISTER(ph);
                                                    ...
                                                    Prolog_term_ref t_ph)
{
  ...
  try {
    ...
    NNC_Polyhedron* ph;
    ph = new NNC_Polyhedron(cs, Recycle_Input());
    Prolog_term_ref tmp = Prolog_new_term_ref();
    Prolog_put_address(tmp, ph);
    if (Prolog_unify(t_ph, tmp)) {
      PPL_REGISTER(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_swap/2";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    swap(*lhs, *rhs);
    return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_space_dimension/2";
  try {
    const Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_affine_dimension/2";
  try {
    const Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_get_constraints/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_get_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_glist) {
  static const char* where = "ppl_Polyhedron_get_congruences/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_get_generators(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_glist) {
  static const char* where = "ppl_Polyhedron_get_generators/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_get_minimized_constraints(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_glist) {
  static const char* where = "ppl_Polyhedron_get_minimized_constraints/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_get_minimized_congruences(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_glist) {
  static const char* where = "ppl_Polyhedron_get_minimized_congruences/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_get_minimized_generators(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_glist) {
  static const char* where = "ppl_Polyhedron_get_minimized_generators/2";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_is_empty/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_is_universe/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_is_bounded/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_contains_integer_point/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_is_topologically_closed/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_is_discrete/1";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_topological_closure_assign/1";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_bounds_from_above/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_bounds_from_below(Prolog_term_ref t_ph,
                                       Prolog_term_ref t_expr) {
  static const char* where = "ppl_Polyhedron_bounds_from_below/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression l = build_linear_expression(t_expr, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_maximize/5";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_minimize(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
                       Prolog_term_ref t_n,  Prolog_term_ref t_d,
                       Prolog_term_ref t_maxmin) {
  static const char* where = "ppl_Polyhedron_minimize/5";
  try {
    const Polyhedron* const ph
      = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Polyhedron_maximize_with_point/6";
  try {
    const Polyhedron* const ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
    PPL_DIRTY_TEMP_COEFFICIENT(n);
    PPL_DIRTY_TEMP_COEFFICIENT(d);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_n, Prolog_term_ref t_d,
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Polyhedron_minimize_with_point/6";
  try {
    const Polyhedron* const ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_frequency(Prolog_term_ref t_ph,
                        Prolog_term_ref t_le_expr,
                        Prolog_term_ref t_freqn, Prolog_term_ref t_freqd,
                        Prolog_term_ref t_valn, Prolog_term_ref t_vald) {
  static const char* where = "ppl_Polyhedron_frequency/6";
  try {
    const Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_contains_Polyhedron/2";
  try {
    const Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    if (lhs->contains(*rhs))
      return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_strictly_contains_Polyhedron(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_strictly_contains_Polyhedron/2";
  try {
    const Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_is_disjoint_from_Polyhedron(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_is_disjoint_from_Polyhedron/2";
  try {
    const Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_equals_Polyhedron/2";
  try {
    const Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_OK/1";
  try {
    const Polyhedron* const ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->OK())
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_add_constraint/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_add_congruence/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_add_generator/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    ph->add_generator(build_generator(t_c, where));
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_add_constraints/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_add_congruences/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_generators(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_add_generators/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Generator_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_refine_with_constraint(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Polyhedron_refine_with_constraint/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_refine_with_congruence(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Polyhedron_refine_with_congruence/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_refine_with_constraints(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_refine_with_constraints/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_refine_with_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_refine_with_congruences/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_intersection_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_upper_bound_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_difference_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_concatenate_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_time_elapse_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_poly_hull_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    lhs->poly_hull_assign(*rhs);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_poly_difference_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    lhs->poly_difference_assign(*rhs);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_upper_bound_assign_if_exact";
  try {
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_poly_hull_assign_if_exact";
  try {
   const Polyhedron* xlhs = term_to_handle<Polyhedron >(t_lhs, where);
 if (Interfaces::is_necessarily_closed_for_interfaces(*xlhs)) {
     C_Polyhedron* lhs = term_to_handle<C_Polyhedron >(t_lhs, where);
     ...
     PPL_CHECK(lhs);
     PPL_CHECK(rhs);
     return lhs->poly_hull_assign_if_exact(*rhs) ? PROLOG_SUCCESS : PROLOG_FAILURE;
   }
   else {
     NNC_Polyhedron* lhs = term_to_handle<NNC_Polyhedron >(t_lhs, where);
     const NNC_Polyhedron* rhs = term_to_handle<NNC_Polyhedron >(t_rhs, where);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_positive_time_elapse_assign";
  try {
    const Polyhedron* xlhs = term_to_handle<Polyhedron >(t_lhs, where);
    if (Interfaces::is_necessarily_closed_for_interfaces(*xlhs)) {
      C_Polyhedron* lhs = term_to_handle<C_Polyhedron >(t_lhs, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_simplify_using_context_assign";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_constrains(Prolog_term_ref t_ph,
                          Prolog_term_ref t_v) {
  static const char* where = "ppl_Polyhedron__constrains/1";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_unconstrain_space_dimension(Prolog_term_ref t_ph,
                           Prolog_term_ref t_v) {
  static const char* where = "ppl_Polyhedron__unconstrain/1";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  const char* where = "ppl_Polyhedron_affine_image/4";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_le, Prolog_term_ref t_d) {
  const char* where = "ppl_Polyhedron_affine_preimage/4";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Polyhedron_bounded_affine_image/5";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_lb_le, Prolog_term_ref t_ub_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Polyhedron_bounded_affine_preimage/5";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Polyhedron_generalized_affine_image/5";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_r, Prolog_term_ref t_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Polyhedron_generalized_affine_preimage/5";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_generalized_affine_image_lhs_rhs/4";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_lhs, Prolog_term_ref t_r, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_generalized_affine_preimage_lhs_rhs/4";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Relation_Symbol r = term_to_relation_symbol(t_r, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_add_space_dimensions_and_embed/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph, Prolog_term_ref t_nnd) {
  static const char* where = "ppl_Polyhedron_add_space_dimensions_and_project/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    dimension_type d = term_to_unsigned<dimension_type>(t_nnd, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_remove_space_dimensions/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_remove_higher_space_dimensions/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_expand_space_dimension/3";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_fold_space_dimensions/3";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_map_space_dimensions/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_drop_some_non_integer_points/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Prolog_atom p_cc = term_to_complexity_class(t_cc, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_drop_some_non_integer_points_2/3";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph) {
  static const char* where = "ppl_Polyhedron_ascii_dump/1";
  try {
    const Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_external_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Polyhedron_external_memory_in_bytes/2";
  try {
    Polyhedron* pps = term_to_handle<Polyhedron >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_total_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Polyhedron_total_memory_in_bytes/2";
  try {
    Polyhedron* pps = term_to_handle<Polyhedron >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_BHRZ03_widening_assign_with_tokens/4";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    lhs->BHRZ03_widening_assign(*rhs, &t);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_H79_widening_assign_with_tokens/4";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_BHRZ03_widening_assign/2";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    lhs->BHRZ03_widening_assign(*rhs, 0);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_H79_widening_assign/2";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_widening_assign_with_tokens/4";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_widening_assign/2";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_limited_BHRZ03_extrapolation_assign_with_tokens/5";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    unsigned t = term_to_unsigned<unsigned>(t_ti, where);
    lhs->limited_BHRZ03_extrapolation_assign(*rhs, cs, &t);
    if (unify_long(t_to, t))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_bounded_BHRZ03_extrapolation_assign_with_tokens/5";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    unsigned t = term_to_unsigned<unsigned>(t_ti, where);
    lhs->bounded_BHRZ03_extrapolation_assign(*rhs, cs, &t);
    if (unify_long(t_to, t))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_limited_H79_extrapolation_assign_with_tokens/5";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Polyhedron_bounded_H79_extrapolation_assign_with_tokens/5";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    unsigned t = term_to_unsigned<unsigned>(t_ti, where);
    lhs->bounded_H79_extrapolation_assign(*rhs, cs, &t);
    if (unify_long(t_to, t))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_limited_BHRZ03_extrapolation_assign/3";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    lhs->limited_BHRZ03_extrapolation_assign(*rhs, cs, 0);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_bounded_BHRZ03_extrapolation_assign/3";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    lhs->bounded_BHRZ03_extrapolation_assign(*rhs, cs, 0);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_limited_H79_extrapolation_assign/3";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_bounded_H79_extrapolation_assign/3";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    ...
    lhs->bounded_H79_extrapolation_assign(*rhs, cs, 0);
    return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
ppl_Polyhedron_linear_partition(Prolog_term_ref t_ph,
  ...
  try {
    static const char* where = "ppl_Polyhedron_linear_partition/4";
    Polyhedron* rfh;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Polyhedron_wrap_assign/8";
  try {
    Polyhedron* pph = term_to_handle<Polyhedron >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_MS_C_Polyhedron/1";
  try {
    C_Polyhedron* pset = term_to_handle<C_Polyhedron >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_PR_C_Polyhedron/1";
  try {
    C_Polyhedron* pset = term_to_handle<C_Polyhedron >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_MS_NNC_Polyhedron/1";
  try {
    NNC_Polyhedron* pset = term_to_handle<NNC_Polyhedron >(t_pset, where);
    PPL_CHECK(pset);
    if (Parma_Polyhedra_Library::termination_test_MS(*pset))
      return PROLOG_SUCCESS;
  }
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_PR_NNC_Polyhedron/1";
  try {
    NNC_Polyhedron* pset = term_to_handle<NNC_Polyhedron >(t_pset, where);
    PPL_CHECK(pset);
    if (Parma_Polyhedra_Library::termination_test_PR(*pset))
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_C_Polyhedron
  (Prolog_term_ref t_pset,
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_NNC_Polyhedron
  (Prolog_term_ref t_pset,
   Prolog_term_ref t_ph_decreasing,
   Prolog_term_ref t_ph_bounded) {
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    C_Polyhedron* pset_before
       = term_to_handle<C_Polyhedron >(t_pset_before, where);
    C_Polyhedron* pset_after
       = term_to_handle<C_Polyhedron >(t_pset_after, where);
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    NNC_Polyhedron* pset_before
       = term_to_handle<NNC_Polyhedron >(t_pset_before, where);
    NNC_Polyhedron* pset_after
       = term_to_handle<NNC_Polyhedron >(t_pset_after, where);
    PPL_CHECK(pset_before);
    PPL_CHECK(pset_after);
    if (Parma_Polyhedra_Library
        ::termination_test_MS_2(*pset_before, *pset_after))
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_C_Polyhedron_2
  (Prolog_term_ref t_pset_before,
   Prolog_term_ref t_pset_after,
   Prolog_term_ref t_ph_decreasing,
   Prolog_term_ref t_ph_bounded) {
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_NNC_Polyhedron_2
  (Prolog_term_ref t_pset_before,
   Prolog_term_ref t_pset_after,
   Prolog_term_ref t_ph_decreasing,
   Prolog_term_ref t_ph_bounded) {
