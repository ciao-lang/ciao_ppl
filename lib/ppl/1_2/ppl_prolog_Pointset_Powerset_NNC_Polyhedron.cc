...
#include "ppl_prolog_Pointset_Powerset_NNC_Polyhedron.hh"
...
(Prolog_term_ref t_ph_source, Prolog_term_ref t_ph)
{
  ...
  try {
    Pointset_Powerset<NNC_Polyhedron>* ph;
    const Pointset_Powerset<NNC_Polyhedron>* const ph_source
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    const Pointset_Powerset<NNC_Polyhedron>* const ph
      = term_to_handle<Pointset_Powerset<NNC_Polyhedron> >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->is_empty())
      return PROLOG_SUCCESS;
  }
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  ...
  try {
    const Pointset_Powerset<NNC_Polyhedron>* const ph = term_to_handle<Pointset_Powerset<NNC_Polyhedron> >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
    PPL_DIRTY_TEMP_COEFFICIENT(n);
    PPL_DIRTY_TEMP_COEFFICIENT(d);
...
extern "C" Prolog_foreign_return_type
  ppl_Pointset_Powerset_NNC_Polyhedron_refine_with_constraint(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
...
extern "C" Prolog_foreign_return_type
  ppl_Pointset_Powerset_NNC_Polyhedron_refine_with_congruence(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Pointset_Powerset_NNC_Polyhedron_drop_some_non_integer_points/2";
  try {
    Pointset_Powerset<NNC_Polyhedron>* ph = term_to_handle<Pointset_Powerset<NNC_Polyhedron> >(t_ph, where);
    PPL_CHECK(ph);
    Prolog_atom p_cc = term_to_complexity_class(t_cc, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Pointset_Powerset_NNC_Polyhedron_drop_some_non_integer_points_2/3";
  try {
    Pointset_Powerset<NNC_Polyhedron>* ph = term_to_handle<Pointset_Powerset<NNC_Polyhedron> >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    ...
    NNC_Polyhedron* disj
      = const_cast<NNC_Polyhedron*>(&((*it)->pointset()));
