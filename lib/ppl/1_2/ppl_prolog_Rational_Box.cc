/* Prolog Rational_Box interface code: definitions.
...
#include "ppl_prolog_Rational_Box.hh"
#include "ppl_prolog_sysdep.hh"
#include "ppl_prolog_common_defs.hh"

extern "C" Prolog_foreign_return_type
  ppl_delete_Rational_Box(Prolog_term_ref t_ph) {
  static const char* where = "ppl_delete_Rational_Box/1";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_UNREGISTER(ph);
    delete ph;
...
extern "C" Prolog_foreign_return_type
ppl_new_Rational_Box_from_space_dimension(Prolog_term_ref t_nd,
                                               Prolog_term_ref t_uoe,
                                               Prolog_term_ref t_ph) {
  static const char* where = "ppl_new_Rational_Box_from_space_dimension/3";
  try {
    Rational_Box* ph;
    Prolog_atom uoe = term_to_universe_or_empty(t_uoe, where);

    if (uoe == a_empty)
      ph = new Rational_Box(term_to_unsigned<dimension_type>(t_nd,
                                                                      where),
                                     EMPTY);
    else
      ph = new Rational_Box(term_to_unsigned<dimension_type>(t_nd,
                     ...
                     Prolog_term_ref t_cc)
{
  ...
  try {
    ...
    PPL_CHECK(ph_source);
    ph = new Rational_Box(*ph_source, cc);
...
extern "C" Prolog_foreign_return_type
  ppl_new_Rational_Box_from_constraints(Prolog_term_ref t_clist,
                                                    Prolog_term_ref t_ph)
{
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ppl_new_Rational_Box_from_congruences(Prolog_term_ref t_clist,
                                                    Prolog_term_ref t_ph)
{
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ppl_new_Rational_Box_from_generators(Prolog_term_ref t_clist,
                                                    Prolog_term_ref t_ph)
{
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_swap(Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_swap/2";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    swap(*lhs, *rhs);
    return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_space_dimension(Prolog_term_ref t_ph, Prolog_term_ref t_sd) {
  static const char* where = "ppl_Rational_Box_space_dimension/2";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_affine_dimension(Prolog_term_ref t_ph, Prolog_term_ref t_sd) {
  static const char* where = "ppl_Rational_Box_affine_dimension/2";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_relation_with_constraint(Prolog_term_ref t_ph,
                                                 Prolog_term_ref t_c,
                                                 Prolog_term_ref t_r) {
  static const char* where =
    "ppl_Rational_Box_relation_with_constraint/3";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_relation_with_generator(Prolog_term_ref t_ph,
                                                 Prolog_term_ref t_c,
                                                 Prolog_term_ref t_r) {
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_relation_with_congruence(Prolog_term_ref t_ph,
                                                 Prolog_term_ref t_c,
                                                 Prolog_term_ref t_r) {
  static const char* where =
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_get_constraints(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_glist) {
  static const char* where = "ppl_Rational_Box_get_constraints/2";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_get_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_glist) {
  static const char* where = "ppl_Rational_Box_get_congruences/2";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_get_minimized_constraints(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_glist) {
  static const char* where = "ppl_Rational_Box_get_minimized_constraints/2";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_get_minimized_congruences(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_glist) {
  static const char* where = "ppl_Rational_Box_get_minimized_congruences/2";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_empty(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_is_empty/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_universe(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_is_universe/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_bounded(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_is_bounded/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_contains_integer_point(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_contains_integer_point/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_topologically_closed(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_is_topologically_closed/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_discrete(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_is_discrete/1";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_topological_closure_assign(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_topological_closure_assign/1";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_bounds_from_above(Prolog_term_ref t_ph,
                                       Prolog_term_ref t_expr) {
  static const char* where = "ppl_Rational_Box_bounds_from_above/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_bounds_from_below(Prolog_term_ref t_ph,
                                       Prolog_term_ref t_expr) {
  static const char* where = "ppl_Rational_Box_bounds_from_below/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression l = build_linear_expression(t_expr, where);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_has_upper_bound(Prolog_term_ref t_ph,
                       Prolog_term_ref t_v,
                       Prolog_term_ref t_n, Prolog_term_ref t_d,
                       Prolog_term_ref t_closed) {
  static const char* where = "ppl_Rational_Box_has_upper_bound/5";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    ...
    bool closed;
    if (ph->has_upper_bound(v, n, d, closed)) {
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_has_lower_bound(Prolog_term_ref t_ph,
                       Prolog_term_ref t_v,
                       Prolog_term_ref t_n, Prolog_term_ref t_d,
                       Prolog_term_ref t_closed) {
  static const char* where = "ppl_Rational_Box_has_lower_bound/5";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Variable v = term_to_Variable(t_v, where);
    ...
    PPL_DIRTY_TEMP_COEFFICIENT(d);
    bool closed;
    if (ph->has_lower_bound(v, n, d, closed)) {
      Prolog_term_ref t = Prolog_new_term_ref();
      Prolog_atom a = (closed ? a_true : a_false);
      Prolog_put_atom(t, a);
      if (Prolog_unify_Coefficient(t_n, n)
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_maximize(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
                       Prolog_term_ref t_n,  Prolog_term_ref t_d,
                       Prolog_term_ref t_maxmin) {
  static const char* where = "ppl_Rational_Box_maximize/5";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_minimize(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
                       Prolog_term_ref t_n,  Prolog_term_ref t_d,
                       Prolog_term_ref t_maxmin) {
  static const char* where = "ppl_Rational_Box_minimize/5";
  try {
    const Rational_Box* const ph
      = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Rational_Box_maximize_with_point/6";
  try {
    const Rational_Box* const ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
    PPL_DIRTY_TEMP_COEFFICIENT(n);
    PPL_DIRTY_TEMP_COEFFICIENT(d);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_n, Prolog_term_ref t_d,
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Rational_Box_minimize_with_point/6";
  try {
    const Rational_Box* const ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_frequency(Prolog_term_ref t_ph,
                        Prolog_term_ref t_le_expr,
                        Prolog_term_ref t_freqn, Prolog_term_ref t_freqd,
                        Prolog_term_ref t_valn, Prolog_term_ref t_vald) {
  static const char* where = "ppl_Rational_Box_frequency/6";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_contains_Rational_Box(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_contains_Rational_Box/2";
  try {
    const Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    if (lhs->contains(*rhs))
      return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_strictly_contains_Rational_Box(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_strictly_contains_Rational_Box/2";
  try {
    const Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_is_disjoint_from_Rational_Box(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_is_disjoint_from_Rational_Box/2";
  try {
    const Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_equals_Rational_Box(Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_equals_Rational_Box/2";
  try {
    const Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_OK(Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_OK/1";
  try {
    const Rational_Box* const ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->OK())
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_add_constraint(Prolog_term_ref t_ph, Prolog_term_ref t_c) {
  static const char* where = "ppl_Rational_Box_add_constraint/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_add_congruence(Prolog_term_ref t_ph, Prolog_term_ref t_c) {
  static const char* where = "ppl_Rational_Box_add_congruence/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_add_constraints(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Rational_Box_add_constraints/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_add_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Rational_Box_add_congruences/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_refine_with_constraint(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Rational_Box_refine_with_constraint/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_refine_with_congruence(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Rational_Box_refine_with_congruence/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_refine_with_constraints(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Rational_Box_refine_with_constraints/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_refine_with_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Rational_Box_refine_with_congruences/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_intersection_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_upper_bound_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_difference_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_concatenate_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_time_elapse_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_upper_bound_assign_if_exact";
  try {
   Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_simplify_using_context_assign";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_constrains(Prolog_term_ref t_ph,
                          Prolog_term_ref t_v) {
  static const char* where = "ppl_Rational_Box__constrains/1";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_unconstrain_space_dimension(Prolog_term_ref t_ph,
                           Prolog_term_ref t_v) {
  static const char* where = "ppl_Rational_Box__unconstrain/1";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_unconstrain_space_dimensions(Prolog_term_ref t_ph,
...
extern "C" Prolog_foreign_return_type
  ...
  const char* where = "ppl_Rational_Box_affine_image/4";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_le, Prolog_term_ref t_d) {
  const char* where = "ppl_Rational_Box_affine_preimage/4";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Rational_Box_bounded_affine_image/5";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_lb_le, Prolog_term_ref t_ub_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Rational_Box_bounded_affine_preimage/5";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Rational_Box_generalized_affine_image/5";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_r, Prolog_term_ref t_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Rational_Box_generalized_affine_preimage/5";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_generalized_affine_image_lhs_rhs/4";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_lhs, Prolog_term_ref t_r, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_generalized_affine_preimage_lhs_rhs/4";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Relation_Symbol r = term_to_relation_symbol(t_r, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_add_space_dimensions_and_embed/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph, Prolog_term_ref t_nnd) {
  static const char* where = "ppl_Rational_Box_add_space_dimensions_and_project/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    dimension_type d = term_to_unsigned<dimension_type>(t_nnd, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_remove_space_dimensions/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_remove_higher_space_dimensions/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_expand_space_dimension/3";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_fold_space_dimensions/3";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_map_space_dimensions/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_drop_some_non_integer_points/2";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
    Prolog_atom p_cc = term_to_complexity_class(t_cc, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_drop_some_non_integer_points_2/3";
  try {
    Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_ascii_dump
  (Prolog_term_ref t_ph) {
  static const char* where = "ppl_Rational_Box_ascii_dump/1";
  try {
    const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_external_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Rational_Box_external_memory_in_bytes/2";
  try {
    Rational_Box* pps = term_to_handle<Rational_Box >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ppl_Rational_Box_total_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Rational_Box_total_memory_in_bytes/2";
  try {
    Rational_Box* pps = term_to_handle<Rational_Box >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_CC76_widening_assign_with_tokens/4";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_CC76_widening_assign/2";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Rational_Box_widening_assign_with_tokens/4";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_widening_assign/2";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist,
   Prolog_term_ref t_ti, Prolog_term_ref t_to) {
  static const char* where = "ppl_Rational_Box_limited_CC76_extrapolation_assign_with_tokens/5";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs, Prolog_term_ref t_clist) {
  static const char* where = "ppl_Rational_Box_limited_CC76_extrapolation_assign/3";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Rational_Box_CC76_narrowing_assign/2";
  try {
    Rational_Box* lhs = term_to_handle<Rational_Box >(t_lhs, where);
    const Rational_Box* rhs = term_to_handle<Rational_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
ppl_Rational_Box_linear_partition(Prolog_term_ref t_ph,
                             Prolog_term_ref t_qh,
                             Prolog_term_ref t_inters,
                             Prolog_term_ref t_pset) {
  try {
    static const char* where = "ppl_Rational_Box_linear_partition/4";
    Rational_Box* rfh;
    Pointset_Powerset<NNC_Polyhedron>* rsh;
  const Rational_Box* ph = term_to_handle<Rational_Box >(t_ph, where);
  const Rational_Box* qh = term_to_handle<Rational_Box >(t_qh, where);
  PPL_CHECK(ph);
  PPL_CHECK(qh);
  std::pair<Rational_Box, Pointset_Powerset<NNC_Polyhedron> >
    r = linear_partition(*ph, *qh);
  rfh = new Rational_Box(0, EMPTY);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Rational_Box_wrap_assign/8";
  try {
    Rational_Box* pph = term_to_handle<Rational_Box >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_MS_Rational_Box/1";
  try {
    Rational_Box* pset = term_to_handle<Rational_Box >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_PR_Rational_Box/1";
  try {
    Rational_Box* pset = term_to_handle<Rational_Box >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_Rational_Box
  (Prolog_term_ref t_pset,
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    Rational_Box* pset_before
       = term_to_handle<Rational_Box >(t_pset_before, where);
    Rational_Box* pset_after
       = term_to_handle<Rational_Box >(t_pset_after, where);
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_Rational_Box_2
  (Prolog_term_ref t_pset_before,
   Prolog_term_ref t_pset_after,
   Prolog_term_ref t_ph_decreasing,
   Prolog_term_ref t_ph_bounded) {
