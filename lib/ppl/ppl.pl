...
:- doc(module, "This module provides an interface with Parma Polyhedra
   Library (PPL). It is a patched version of the interface available
   in the source code of PPL 0.9 (Warning : It should not work with
   any other version of PPL). For more information about the
