...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_frequency(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
...
extern "C" Prolog_foreign_return_type
  ppl_termination_test_MS_C_Polyhedron(Prolog_term_ref t_pset);

extern "C" Prolog_foreign_return_type
  ppl_termination_test_PR_C_Polyhedron(Prolog_term_ref t_pset);

extern "C" Prolog_foreign_return_type
  ppl_termination_test_MS_NNC_Polyhedron(Prolog_term_ref t_pset);

extern "C" Prolog_foreign_return_type
  ppl_termination_test_PR_NNC_Polyhedron(Prolog_term_ref t_pset);
