/* Prolog Double_Box interface code: declarations.
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_has_upper_bound(Prolog_term_ref t_ph, Prolog_term_ref t_v,
		       Prolog_term_ref t_n, Prolog_term_ref t_d,
		       Prolog_term_ref t_closed);

extern "C" Prolog_foreign_return_type
  ppl_Double_Box_has_lower_bound(Prolog_term_ref t_ph, Prolog_term_ref t_v,
		       Prolog_term_ref t_n, Prolog_term_ref t_d,
		       Prolog_term_ref t_closed);
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_frequency(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
...
extern "C" Prolog_foreign_return_type
  ppl_termination_test_MS_Double_Box(Prolog_term_ref t_pset);

extern "C" Prolog_foreign_return_type
  ppl_termination_test_PR_Double_Box(Prolog_term_ref t_pset);
