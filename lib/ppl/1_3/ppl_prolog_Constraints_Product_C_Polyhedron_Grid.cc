/* Prolog Constraints_Product_C_Polyhedron_Grid interface code: definitions.
...
#include "ppl_prolog_Constraints_Product_C_Polyhedron_Grid.hh"
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_delete_Constraints_Product_C_Polyhedron_Grid/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_UNREGISTER(ph);
    delete ph;
...
ppl_new_Constraints_Product_C_Polyhedron_Grid_from_space_dimension(Prolog_term_ref t_nd,
  ...
  static const char* where = "ppl_new_Constraints_Product_C_Polyhedron_Grid_from_space_dimension/3";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph;
    Prolog_atom uoe = term_to_universe_or_empty(t_uoe, where);

    if (uoe == a_empty)
      ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(term_to_unsigned<dimension_type>(t_nd,
                                                                      where),
                                     EMPTY);
    else
      ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(term_to_unsigned<dimension_type>(t_nd,
...
(Prolog_term_ref t_ph_source, Prolog_term_ref t_ph)
{
  ...
  try {
    ...
    PPL_CHECK(ph_source);
    ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(*ph_source);
    Prolog_term_ref tmp = Prolog_new_term_ref();
    Prolog_put_address(tmp, ph);
    if (Prolog_unify(t_ph, tmp)) {
      PPL_REGISTER(ph);
...
(Prolog_term_ref t_ph_source, Prolog_term_ref t_ph)
{
  ...
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph;
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph_source
      = static_cast<const Domain_Product<C_Polyhedron,Grid >::Constraints_Product*>
        (term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph_source, where));
    PPL_CHECK(ph_source);
    ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(*ph_source);
    Prolog_term_ref tmp = Prolog_new_term_ref();
    Prolog_put_address(tmp, ph);
                     ...
                     Prolog_term_ref t_cc)
{
  ...
  try {
    ...
    PPL_CHECK(ph_source);
    ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(*ph_source, cc);
                     ...
                     Prolog_term_ref t_cc)
{
  ...
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph;
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph_source
        = static_cast<const Domain_Product<C_Polyhedron,Grid >::Constraints_Product*>
        (term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph_source, where));
                                                    ...
                                                    Prolog_term_ref t_ph)
{
  ...
  try {
    ...
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph;
    ph = new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(cs);
    Prolog_term_ref tmp = Prolog_new_term_ref();
    Prolog_put_address(tmp, ph);
    if (Prolog_unify(t_ph, tmp)) {
      PPL_REGISTER(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_swap/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    swap(*lhs, *rhs);
    return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_space_dimension/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_affine_dimension/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_empty/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->is_empty())
      return PROLOG_SUCCESS;
  }
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_universe/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_bounded/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_topologically_closed/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_discrete/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_topological_closure_assign/1";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_bounds_from_above/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_bounds_from_below(Prolog_term_ref t_ph,
                                       Prolog_term_ref t_expr) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_bounds_from_below/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression l = build_linear_expression(t_expr, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_maximize/5";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_minimize(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
                       Prolog_term_ref t_n,  Prolog_term_ref t_d,
                       Prolog_term_ref t_maxmin) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_minimize/5";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph
      = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_maximize_with_point/6";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
    PPL_DIRTY_TEMP_COEFFICIENT(n);
    PPL_DIRTY_TEMP_COEFFICIENT(d);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_n, Prolog_term_ref t_d,
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_minimize_with_point/6";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_contains_Constraints_Product_C_Polyhedron_Grid/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    if (lhs->contains(*rhs))
      return PROLOG_SUCCESS;
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_strictly_contains_Constraints_Product_C_Polyhedron_Grid(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_strictly_contains_Constraints_Product_C_Polyhedron_Grid/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_is_disjoint_from_Constraints_Product_C_Polyhedron_Grid(Prolog_term_ref t_lhs,
                                   Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_is_disjoint_from_Constraints_Product_C_Polyhedron_Grid/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_equals_Constraints_Product_C_Polyhedron_Grid/2";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_OK/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* const ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->OK())
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_constraint/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_congruence/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_constraints/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_add_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_congruences/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_constraint(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_constraint/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_congruence(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_congruence/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_constraints(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_constraints/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_congruences(Prolog_term_ref t_ph,
                                   Prolog_term_ref t_clist) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_refine_with_congruences/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_intersection_assign";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_upper_bound_assign";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_difference_assign";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_concatenate_assign";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_time_elapse_assign";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_upper_bound_assign_if_exact";
  try {
   Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_constrains(Prolog_term_ref t_ph,
                          Prolog_term_ref t_v) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid__constrains/1";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_unconstrain_space_dimension(Prolog_term_ref t_ph,
                           Prolog_term_ref t_v) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid__unconstrain/1";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_affine_image/4";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_le, Prolog_term_ref t_d) {
  const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_affine_preimage/4";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_bounded_affine_image/5";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_lb_le, Prolog_term_ref t_ub_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_bounded_affine_preimage/5";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   ...
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_generalized_affine_image/5";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_v, Prolog_term_ref t_r, Prolog_term_ref t_le,
   Prolog_term_ref t_d) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_generalized_affine_preimage/5";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_generalized_affine_image_lhs_rhs/4";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph,
   Prolog_term_ref t_lhs, Prolog_term_ref t_r, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_generalized_affine_preimage_lhs_rhs/4";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Relation_Symbol r = term_to_relation_symbol(t_r, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_space_dimensions_and_embed/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph, Prolog_term_ref t_nnd) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_add_space_dimensions_and_project/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    dimension_type d = term_to_unsigned<dimension_type>(t_nnd, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_remove_space_dimensions/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_remove_higher_space_dimensions/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_expand_space_dimension/3";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_fold_space_dimensions/3";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_map_space_dimensions/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_drop_some_non_integer_points/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
    Prolog_atom p_cc = term_to_complexity_class(t_cc, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_drop_some_non_integer_points_2/3";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_ph) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_ascii_dump/1";
  try {
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* ph = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_external_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_external_memory_in_bytes/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* pps = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ppl_Constraints_Product_C_Polyhedron_Grid_total_memory_in_bytes(Prolog_term_ref t_pps,
                         Prolog_term_ref t_m) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_total_memory_in_bytes/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* pps = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_pps, where);
    PPL_CHECK(pps);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_widening_assign_with_tokens/4";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Constraints_Product_C_Polyhedron_Grid_widening_assign/2";
  try {
    Domain_Product<C_Polyhedron,Grid >::Constraints_Product* lhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_lhs, where);
    const Domain_Product<C_Polyhedron,Grid >::Constraints_Product* rhs = term_to_handle<Domain_Product<C_Polyhedron,Grid >::Constraints_Product >(t_rhs, where);
    PPL_CHECK(lhs);
