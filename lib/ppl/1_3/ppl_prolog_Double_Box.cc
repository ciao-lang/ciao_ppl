...
#include "ppl_prolog_Double_Box.hh"
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    const Double_Box* const ph
      = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_has_upper_bound(Prolog_term_ref t_ph,
                       Prolog_term_ref t_v,
                       Prolog_term_ref t_n, Prolog_term_ref t_d,
                       Prolog_term_ref t_closed) {
  static const char* where = "ppl_Double_Box_has_upper_bound/5";
  try {
    const Double_Box* ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_has_lower_bound(Prolog_term_ref t_ph,
                       Prolog_term_ref t_v,
                       Prolog_term_ref t_n, Prolog_term_ref t_d,
                       Prolog_term_ref t_closed) {
  static const char* where = "ppl_Double_Box_has_lower_bound/5";
  try {
    const Double_Box* ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Variable v = term_to_Variable(t_v, where);
...
(Prolog_term_ref t_ph,
 ...
 Prolog_term_ref t_maxmin, Prolog_term_ref t_g) {
  ...
  try {
    const Double_Box* const ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
    PPL_DIRTY_TEMP_COEFFICIENT(n);
    PPL_DIRTY_TEMP_COEFFICIENT(d);
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_frequency(Prolog_term_ref t_ph,
                        Prolog_term_ref t_le_expr,
                        Prolog_term_ref t_freqn, Prolog_term_ref t_freqd,
                        Prolog_term_ref t_valn, Prolog_term_ref t_vald) {
  static const char* where = "ppl_Double_Box_frequency/6";
  try {
    const Double_Box* ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
    const Linear_Expression le = build_linear_expression(t_le_expr, where);
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_refine_with_constraint(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
...
extern "C" Prolog_foreign_return_type
  ppl_Double_Box_refine_with_congruence(Prolog_term_ref t_ph,
                                             Prolog_term_ref t_c) {
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Double_Box_drop_some_non_integer_points/2";
  try {
    Double_Box* ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
    Prolog_atom p_cc = term_to_complexity_class(t_cc, where);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Double_Box_drop_some_non_integer_points_2/3";
  try {
    Double_Box* ph = term_to_handle<Double_Box >(t_ph, where);
    PPL_CHECK(ph);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Double_Box_CC76_narrowing_assign/2";
  try {
    Double_Box* lhs = term_to_handle<Double_Box >(t_lhs, where);
    const Double_Box* rhs = term_to_handle<Double_Box >(t_rhs, where);
    PPL_CHECK(lhs);
...
extern "C" Prolog_foreign_return_type
  ...
  static const char* where = "ppl_Double_Box_wrap_assign/8";
  try {
    Double_Box* pph = term_to_handle<Double_Box >(t_ph, where);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_MS_Double_Box/1";
  try {
    Double_Box* pset = term_to_handle<Double_Box >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_pset) {
  static const char* where = "ppl_termination_test_PR_Double_Box/1";
  try {
    Double_Box* pset = term_to_handle<Double_Box >(t_pset, where);
    PPL_CHECK(pset);
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_Double_Box
  (Prolog_term_ref t_pset,
...
extern "C" Prolog_foreign_return_type
  ...
  try {
    Double_Box* pset_before
       = term_to_handle<Double_Box >(t_pset_before, where);
    Double_Box* pset_after
       = term_to_handle<Double_Box >(t_pset_after, where);
...
extern "C" Prolog_foreign_return_type
  ppl_all_affine_quasi_ranking_functions_MS_Double_Box_2
  (Prolog_term_ref t_pset_before,
   Prolog_term_ref t_pset_after,
   Prolog_term_ref t_ph_decreasing,
   Prolog_term_ref t_ph_bounded) {
