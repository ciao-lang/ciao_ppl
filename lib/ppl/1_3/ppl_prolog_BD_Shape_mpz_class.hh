/* Prolog BD_Shape_mpz_class interface code: declarations.
...
extern "C" Prolog_foreign_return_type
  ppl_BD_Shape_mpz_class_maximize_with_point(Prolog_term_ref t_ph,
...
extern "C" Prolog_foreign_return_type
  ppl_BD_Shape_mpz_class_minimize_with_point(Prolog_term_ref t_ph,
				  Prolog_term_ref t_le_expr,
				  Prolog_term_ref t_n,
                                  Prolog_term_ref t_d,
				  Prolog_term_ref t_maxmin,
...
extern "C" Prolog_foreign_return_type
  ppl_BD_Shape_mpz_class_frequency(Prolog_term_ref t_ph, Prolog_term_ref t_le_expr,
...
extern "C" Prolog_foreign_return_type
  ppl_BD_Shape_mpz_class_refine_with_constraint(Prolog_term_ref t_ph, Prolog_term_ref t_c);

extern "C" Prolog_foreign_return_type
  ppl_BD_Shape_mpz_class_refine_with_congruence(Prolog_term_ref t_ph, Prolog_term_ref t_c);
...
extern "C" Prolog_foreign_return_type
  ppl_termination_test_MS_BD_Shape_mpz_class(Prolog_term_ref t_pset);

extern "C" Prolog_foreign_return_type
  ppl_termination_test_PR_BD_Shape_mpz_class(Prolog_term_ref t_pset);
